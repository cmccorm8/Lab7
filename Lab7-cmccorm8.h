...
using std::sort;
//--------------------------------BUBBLE SORT------------------------------------------------------
template <typename RandomAccessIterator>									//http://rosettacode.org/wiki/Sorting_algorithms/Bubble_sort#C.2B.2B
...
//----------------------------SELECTION SORT-------------------------------------------------------------------------
template<typename ForwardIterator> void selection_sort(ForwardIterator begin,		//http://rosettacode.org/wiki/Sorting_algorithms/Selection_sort#C.2B.2B
	ForwardIterator end) {
	for (auto i = begin; i != end; ++i) {
...
template<typename RandomAccessIterator>									//http://rosettacode.org/wiki/Sorting_algorithms/Merge_sort#C.2B.2B
...
//-----------------------INSERTION SORT--------------------------------------------------------------------------
template <typename RandomAccessIterator, typename Predicate>			//http://rosettacode.org/wiki/Sorting_algorithms/Insertion_sort#C.2B.2B
